...
export const metadata: Metadata = {
  ...
  description:
    "Encyclopédie complète d'usinage et de rectification. Fraisage, tournage, rectification : guides illustrés, quiz interactifs et calculateurs.",
}
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {categories.map((cat) => (
              <Link
                key={cat.href}
                href={cat.href}
                className="animate-fade-in group relative overflow-hidden rounded-2xl border border-border bg-card p-6 backdrop-blur-sm transition-all hover:border-primary/30 hover:shadow-xl hover:shadow-primary/5"
              >
                <div
